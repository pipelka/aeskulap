 ...
 *
 *  Purpose: representation parameter for JPEG 2000 lossless only
 *
 *  Last Update:      $Author: braindead $
 *  Update Date:      $Date: 2006/02/28 22:39:34 $
 *  Source File:      $Source: /cvsroot/aeskulap/aeskulap/dcmjp2/include/Attic/djp2rplol.h,v $
...
/** representation parameter for JPEG 2000 lossless only
 */
class DJP2_RPLossless: public DcmRepresentationParameter
{
public:
  ...
  /// copy constructor
  DJP2_RPLossless(const DJP2_RPLossless& arg);

  /// destructor
  virtual ~DJP2_RPLossless();
